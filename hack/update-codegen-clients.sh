...
bash "${CODEGEN_PKG}"/generate-groups.sh "deepcopy,client,informer,lister" \
  ...
  "workload:v1alpha1 apiresource:v1alpha1 tenancy:v1alpha1 tenancy:v1beta1 apis:v1alpha1 scheduling:v1alpha1 redhat:v1" \
...
--input-dirs github.com/kcp-dev/kcp/pkg/apis/redhat/v1 \
